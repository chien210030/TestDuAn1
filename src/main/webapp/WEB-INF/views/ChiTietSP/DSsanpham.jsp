            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${SP}" var="i">
                    <tr>
                        <td>${i.ma}</td>
                        <td>${i.ten}</td>
                        <td><a class="btn btn-danger" href="${pageContext.request.contextPath}/deletesp/${i.id}">Delete</a></td>
                    <td><a class="btn btn-warning" href="${pageContext.request.contextPath}/viewupdateSP/${i.id}">update</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
