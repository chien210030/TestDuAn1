...
<div class="container-fluid">
    ...
    <div class="col-md-9 animated bounce">
        ...
        <form action="${pageContext.request.contextPath}/addDongsp" method="post">
            ...
            <div class="mb-3 mt-3">
                <label >Mã:</label>
                <input type="text" class="form-control"   placeholder="Enter mota" name="ma" value="${updateDongSP.ma}">
            </div>
            <div class="mb-3 mt-3">
                <label >Tên:</label>
                <input type="text" class="form-control"   placeholder="Enter mota" name="ten" value="${updateDongSP.ten}">
            </div>
